...
void Camerasp::write_JPEG_file (std::string const& filename, ImgInfo const& img)
{
...
ImgInfo
read_JPEG_file (std::string const& filename)
{
  ...
  while (cinfo.output_scanline < cinfo.output_height) {
    ...
    info.put_scan_line(buffer[0], row_stride);
  }
  info.image_height = cinfo.output_height;
  info.image_width = cinfo.output_width;
